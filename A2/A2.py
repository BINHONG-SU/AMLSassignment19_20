...
class A2:
    ...
    def train(self,x_train, y_train):
        param_grid={'C':[1,5,10,50,100,200,400,800],'gamma':np.logspace(-22,-18,5,endpoint=True, base=2)}   #Set the hyperparameters need to be trained
        ...
        print('A2 best estimator',clf.best_estimator_)
        print('acc_A2_val',clf.best_score_)
    ...
    def plot_learning_curve(self,x_train,y_train):
        train_sizes, train_scores, test_scores=learning_curve(self.model, x_train, y_train, train_sizes=np.linspace(0.1, 1.0, 10), cv=5, n_jobs=-1) #get the training scores, testing scores of estimator, use 5-fold cross validation
