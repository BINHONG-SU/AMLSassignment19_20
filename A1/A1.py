...
class A1:
    def train(self,x_train, y_train):
        param_grid={'C':[0.1,0.5,1,5,10,50,100],'gamma':np.logspace(-9,1,11,endpoint=True, base=10)}#np.logspace(-5, 5, 11, endpoint=True, base=10)}#,'gamma':np.logspace(-15,3,19,endpoint=True, base=2)}
